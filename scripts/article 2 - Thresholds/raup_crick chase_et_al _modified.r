raup_crick=function(spXsite, classic_metric=FALSE, split_ties=TRUE,
                    reps=9999, set_all_species_equal=FALSE, as.distance.matrix=TRUE, 
...
##NOT recommended- this is a non-trivial change to the metric: ##sets all species to occur with equal frequency in the null model ##e.g.- discards any occupancy frequency information
...
null_array<-list()
print(alpha_levels)
##looping over each combination of alpha levels:   ### could be parallelized at least
...
##how many null values are bigger than the observed value?  ### modified to less than observed
